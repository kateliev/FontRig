	...
	init: async function(onProgress) {
		...
		try {
			...
			this.pyodide.runPython([
				...
				'# Curve actions additionally declare CurveActions as their 4th positional parameter;',
				'# inspect detects this and injects it automatically \u2014 no naming convention needed.',
				...
				'    if len(params) > 3 and params[3] == "CurveActions":',
				'        return fn(glyph, scope_layers, NodeActions, CurveActions, *args, **kw)',
