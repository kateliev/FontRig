...
FontRig.pyBridge = {
	...
	manifest: [
		...
		'typerig/core/actions/contour-actions.py',
		'typerig/core/actions/draw-actions.py',
	],
	...
	init: async function(onProgress) {
		...
		try {
			...
			this.pyodide.runPython([
				...
				'',
				'# Import curve-actions (non-fatal)',
				'CurveActions = None',
				'try:',
				'    import importlib.util as _ilu',
				'    _ca_path = __import__("site").getsitepackages()[0] + "/typerig/core/actions/curve-actions.py"',
				'    _spec = _ilu.spec_from_file_location("curve_actions", _ca_path)',
				'    _mod = _ilu.module_from_spec(_spec)',
				'    _spec.loader.exec_module(_mod)',
				'    CurveActions = _mod.CurveActions',
				'    sys.modules["typerig.core.actions.curve_actions"] = _mod',
				'    del _ilu, _spec, _mod, _ca_path',
				'except Exception as _e:',
				'    print("Warning: CurveActions not loaded:", _e)',
				'',
				'# Import contour-actions (non-fatal)',
				'ContourActions = None',
				'try:',
				'    import importlib.util as _ilu',
				'    _cta_path = __import__("site").getsitepackages()[0] + "/typerig/core/actions/contour-actions.py"',
				'    _spec = _ilu.spec_from_file_location("contour_actions", _cta_path)',
				'    _mod = _ilu.module_from_spec(_spec)',
				'    _spec.loader.exec_module(_mod)',
				'    ContourActions = _mod.ContourActions',
				'    sys.modules["typerig.core.actions.contour_actions"] = _mod',
				'    del _ilu, _spec, _mod, _cta_path',
				'except Exception as _e:',
				'    print("Warning: ContourActions not loaded:", _e)',
				'',
				'# Import draw-actions (non-fatal)',
				'DrawActions = None',
				'try:',
				'    import importlib.util as _ilu',
				'    _da_path = __import__("site").getsitepackages()[0] + "/typerig/core/actions/draw-actions.py"',
				'    _spec = _ilu.spec_from_file_location("draw_actions", _da_path)',
				'    _mod = _ilu.module_from_spec(_spec)',
				'    _spec.loader.exec_module(_mod)',
				'    DrawActions = _mod.DrawActions',
				'    sys.modules["typerig.core.actions.draw_actions"] = _mod',
				'    del _ilu, _spec, _mod, _da_path',
				'except Exception as _e:',
				'    print("Warning: DrawActions not loaded:", _e)',
				'',
				...
				'# it by name as their 4th positional parameter; inspect detects this and injects',
				'# the correct class from _action_classes automatically.',
				'import inspect as _inspect',
				'_action_classes = {',
				'    "CurveActions":   CurveActions,',
				'    "ContourActions": ContourActions,',
				...
				'        return fn(glyph, scope_layers, NodeActions, _action_classes[params[3]], *args, **kw)',
				...
				'print("           CurveActions:", "loaded" if CurveActions else "not available")',
