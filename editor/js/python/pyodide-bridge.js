...
FontRig.pyBridge = {
	...
	manifest: [
		...
		'typerig/core/actions/node_panel_actions.py',
		'typerig/core/actions/curve_actions.py',
		...
		'typerig/core/algo/mat.py',
		'typerig/core/algo/mat_extract.py',
		'typerig/core/algo/stroke_sep.py',
		'typerig/core/algo/stroke_sep_common.py',
		'typerig/core/algo/stroke_sep_csf.py',
		'typerig/core/algo/stroke_sep_graph.py',
		'typerig/core/algo/stroke_sep_junctions.py',
		'typerig/core/algo/stroke_sep_links.py',
		'typerig/core/algo/stroke_sep_mat.py',
		'typerig/core/algo/stroke_sep_slicer.py',
		'typerig/core/algo/stroke_sep_solver.py',
	],
	...
	init: async function(onProgress) {
		...
		try {
			...
			this.pyodide.runPython([
				...
				'    return result',
				'',
				'# Import core action modules (non-fatal).',
				'# Files are fetched via the manifest above and land at',
				'# typerig/core/actions/<name>.py, so normal imports work.',
				'NodeActions = None',
				'CurveActions = None',
				'ContourActions = None',
				'DrawActions = None',
				...
				'    from typerig.core.actions.contour_actions    import ContourActions',
				'    from typerig.core.actions.draw_actions       import DrawActions',
				'    from typerig.core.actions import node_panel_actions as _npa',
				'except Exception as _e:',
				'    print("Warning: TypeRig action modules not loaded:", _e)',
				'try:',
				...
				'# the correct class from _action_classes automatically. Looks up `name` first in',
				'# node_panel_actions, then in cut_panel_actions.',
